...
const devSchedule: ScheduleData = {
  ...
  'Tuesday': {
    ...
    '17:00': { name: 'Tiny Kids BJJ', startTime: '17:00', duration: 30, types: ['tiny-kids'], uniform: ['Gi'] },
    '17:30': { name: 'Kids BJJ', startTime: '17:30', duration: 60, types: ['kids'], uniform: ['Gi'] },
    '18:30': { name: 'Kids BJJ 13+', startTime: '18:30', duration: 60, types: ['kids-13'], uniform: ['Gi'] },
  ...
  'Wednesday': {
    ...
    '17:30': { name: 'Kids BJJ', startTime: '17:30', duration: 60, types: ['kids'], uniform: ['No Gi'] },
    '18:30': { name: 'Kids BJJ 13+', startTime: '18:30', duration: 60, types: ['kids-13'], uniform: ['No Gi'] },
